                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img src="gambar/wd.jpg" alt="Image" style="object-fit: cover; overflow: hidden; width: 450px; height: 500px;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                ...
                                WHERE username='$user' AND password='$pass'")
                                    ...
                                    ?>
                                        ...
                                        <form class="user" method="POST" action="">
                                            ...
                                            <input type="submit" name="submit" value="Submit" class="btn btn-dark btn-user btn-block">
                                            <hr>
                                        </form>
                                    <?php } ?>
                                    <hr>
